 ...
 */
public class CarIssueAPIServiceTest extends SpringServiceTester {
    @Autowired
    private CarIssuesAPI carIssueService;
    
    @Test
    public void test() {
        loger.info(JSON.toJSONString(carIssueService.getCarsList("王竹林")));
    }
}
